<html>
	<body>
		...
		<form action="view_users_page.php" method="post">
			<div align='center'>
				<h2>View Users</h2>
				<button type='submit' <?php if ($_SESSION['table_view']=='default') echo "disabled='disabled'";?> name='table_view' value='default'/>All</button>
				<button type='submit' <?php if ($_SESSION['table_view']=='admin') echo "disabled='disabled'";?> name='table_view' value='admin'/>Admin</button>
				<button type='submit' <?php if ($_SESSION['table_view']=='parents') echo "disabled='disabled'";?> name='table_view' value='parents'/>Parents</button>
				<button type='submit' <?php if ($_SESSION['table_view']=='students') echo "disabled='disabled'";?> name='table_view' value='students'/>Students</button>
			</div>
			<br><br>
		...
		<table width=100% border='1'>
			<?php
				...
				if ($_SESSION['table_view'] == "students"){
					echo "<th>Parent ID <button type='submit' name='table_sort' ";
					if ($_SESSION['table_sort']=='pidAsc') echo " value='pidDes'>&#9660</button></th>";
					else echo " value='pidAsc'>&#9650</button></th>";
					echo "<th>Grade <button type='submit' name='table_sort' ";
