<html>
	...
	<body>
		<?php
			...
			$gMentee = $_SESSION['group']['mentee_grade_req'];
			$gMentor = $_SESSION['group']['mentor_grade_req'];
		...
		<div class="column1" style="background-color:#f2f2f2;">
			...
			<p class="p1"><b>Mentee Grade: </b> <?php echo "$gMentee"; ?> <br>
			<p class="p1"><b>Mentor Grade (>=): </b> <?php echo "$gMentor"; ?> <br>
